...
export declare abstract class BaseSanityQueryTransformer<CONFIG extends SanityQueryTransformerConfig = SanityQueryTransformerConfig> extends Plugin<CONFIG> {
