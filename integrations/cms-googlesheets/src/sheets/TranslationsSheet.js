...
exports.TranslationsSheet = void 0;
const framework_1 = require("@jovotech/framework");
const lodash_get_1 = __importDefault(require("lodash.get"));
const lodash_set_1 = __importDefault(require("lodash.set"));
const GoogleSheetsCmsSheet_1 = require("./GoogleSheetsCmsSheet");
class TranslationsSheet extends GoogleSheetsCmsSheet_1.GoogleSheetsCmsSheet {
    getDefaultConfig() {
        return { range: 'A:Z' };
    }
    parse(values, jovo) {
...
exports.TranslationsSheet = TranslationsSheet;
//# sourceMappingURL=TranslationsSheet.js.map