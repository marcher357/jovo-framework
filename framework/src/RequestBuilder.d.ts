...
export type RequestBuilderRequest<PLATFORM extends Platform> = PLATFORM extends Platform<infer REQUEST> ? REQUEST : never;
export declare abstract class RequestBuilder<PLATFORM extends Platform> {
