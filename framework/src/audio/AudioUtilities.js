...
exports.AudioUtilities = void 0;
class AudioUtilities {
    static getSamplesFromBase64(base64) {
    ...
    static sampleDown(samples, currentSampleRate, newSampleRate) {
    ...
    static encodeSamplesToWav(samples, sampleRate) {
    ...
    static buildBase64Uri(data, mimeType) {
        return `data:${mimeType};base64,${data}`;
    }
}
exports.AudioUtilities = AudioUtilities;
