...
export declare enum DisplayTemplateType {
    Body1 = "BodyTemplate1",
    Body2 = "BodyTemplate2",
    Body3 = "BodyTemplate3",
    Body6 = "BodyTemplate6",
...
export declare enum BackButtonVisibility {
    Hidden = "HIDDEN",
    Visible = "VISIBLE"
}
export type BackButtonVisibilityLike = EnumLike<BackButtonVisibility>;
export declare class DisplayTemplate<TYPE extends DisplayTemplateTypeLike = DisplayTemplateTypeLike> {
    type: TYPE;
    token: string;
    ...
    listItems?: TYPE extends DisplayTemplateType.List1 ? DisplayTemplateList1Item[] : TYPE extends DisplayTemplateType.List2 ? DisplayTemplateList2Item[] : never;
}
