...
exports.ConnectionPrintWebPageOutput = void 0;
const framework_1 = require("@jovotech/framework");
const OnCompletion_1 = require("../models/common/OnCompletion");
let ConnectionPrintWebPageOutput = class ConnectionPrintWebPageOutput extends framework_1.BaseOutput {
    getDefaultOptions() {
        return {
...
ConnectionPrintWebPageOutput = __decorate([
    (0, framework_1.Output)()
], ConnectionPrintWebPageOutput);
exports.ConnectionPrintWebPageOutput = ConnectionPrintWebPageOutput;
//# sourceMappingURL=ConnectionPrintWebPageOutput.js.map