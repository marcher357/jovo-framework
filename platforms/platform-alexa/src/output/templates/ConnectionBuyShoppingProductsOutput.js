...
exports.ConnectionBuyShoppingProductsOutput = void 0;
const framework_1 = require("@jovotech/framework");
const OnCompletion_1 = require("../models/common/OnCompletion");
let ConnectionBuyShoppingProductsOutput = class ConnectionBuyShoppingProductsOutput extends framework_1.BaseOutput {
    getDefaultOptions() {
        return {
...
ConnectionBuyShoppingProductsOutput = __decorate([
    (0, framework_1.Output)()
], ConnectionBuyShoppingProductsOutput);
exports.ConnectionBuyShoppingProductsOutput = ConnectionBuyShoppingProductsOutput;
//# sourceMappingURL=ConnectionBuyShoppingProductsOutput.js.map