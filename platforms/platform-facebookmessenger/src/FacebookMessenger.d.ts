...
export declare class FacebookMessenger extends AsyncJovo<FacebookMessengerRequest, FacebookMessengerResponse, FacebookMessenger, FacebookMessengerUser, FacebookMessengerDevice, FacebookMessengerPlatform> {
    protected sendResponse(response: FacebookMessengerResponse): Promise<AxiosResponse<SendMessageResult>>;
}
